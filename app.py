...
def update_height():
    ideal_height = st.session_state.width_mm / 1.778
...
# ... (все остальные поля ввода остаются без изменений: монтаж, шаг пикселя, выбор кабинетов, частота, система, процессор и т.д.)
