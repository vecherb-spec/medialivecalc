...
# --- НАСТРОЙКА СТРАНИЦЫ ---
st.set_page_config(page_title="Калькулятор для светодиодных экранов | MediaLive", layout="wide", page_icon="🖥️")

# --- СОВРЕМЕННЫЙ ДИЗАЙН В СТИЛЕ CSS ---
st.markdown("""
<style>
...
def get_cbr_usd_rate():
 ...
 if valute.attrib.get('ID') == 'R01235': # Идентификатор доллара США
...
MODULES_DB = [
 # В ПОМЕЩЕНИИ
 {'name': 'Qiangli Q1.25 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 1.25, 'tech': 'SMD', 'яркость': 600, 'max_power': 30.0, 'price_usd': 44.99}, 
 {'name': 'Qiangli Q1.25 для помещений 6000 Гц', 'env': 'Для помещений', 'высота звука': 1.25, 'tech': 'SMD', 'яркость': 600, 'max_power': 30.0, 'price_usd': 46.15}, 
 {'name': 'Qiangli Q1.25 Частота в помещении 6000 Гц', 'env': 'В помещении', 'высота звука': 1.25, 'tech': 'частота звука', 'яркость': 650, 'max_power': 30.0, 'price_usd': 51.10}, 
 {'name': 'Qiangli R1.5 для помещений с частотой 6000 Гц (Гибкий)', 'env': 'Для помещений', 'высота звука': 1.5, 'tech': 'Гибкая', 'яркость': 500, 'max_power': 23.0, 'price_usd': 33.44}, 
 {'name': 'Qiangli Q1.53 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 1.53, 'tech': 'SMD', 'яркость': 600, 'max_power': 30.0, 'price_usd': 29.42}, 
 {'name': 'VISTECH P1.53 COB для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 1.53, 'tech': 'COB', 'яркость': 600, 'max_power': 30.0, 'price_usd': 42.38},
 {'name': 'Qiangli Q1.53 для помещений с частотой 6000 Гц', 'env': 'Для помещений', 'высота звука': 1.53, 'tech': 'SMD', 'яркость': 600, 'max_power': 30.0, 'price_usd': 30.42}, 
 {'name': 'Qiangli Q1.53 Частота в помещении 6000 Гц', 'env': 'В помещении', 'высота звука': 1.53, 'tech': 'частота звука', 'яркость': 650, 'max_power': 30.0, 'price_usd': 35.15}, 
 {'name': 'Qiangli Q1.66 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 1.66, 'tech': 'SMD', 'яркость': 600, 'max_power': 30.0, 'price_usd': 27.54}, 
 {'name': 'Qiangli Q1.86 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 1.86, 'tech': 'SMD', 'яркость': 500, 'max_power': 23.0, 'price_usd': 18.64}, 
 {'name': 'Qiangli R1.86 для помещений 3840 Гц (Гибкий)', 'env': 'Для помещений', 'высота звука': 1.86, 'tech': 'Гибкая', 'яркость': 500, 'max_power': 23.0, 'price_usd': 21.99}, 
 {'name': 'VISTECH P1.86 COB для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 1.86, 'tech': 'COB', 'яркость': 600, 'max_power': 30.0, 'price_usd': 29.75}, 
 {'name': 'Qiangli Q1.86 для помещений с частотой 6000 Гц', 'env': 'Для помещений', 'высота звука': 1.86, 'tech': 'SMD', 'яркость': 600, 'max_power': 30.0, 'price_usd': 19.99},
 {'name': 'Qiangli R1.86 для помещений 6000 Гц (Гибкий)', 'env': 'Для помещений', 'высота звука': 1.86, 'tech': 'Гибкая', 'яркость': 500, 'max_power': 23.0, 'price_usd': 22.88}, 
 {'name': 'Qiangli Q2 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 2.0, 'tech': 'SMD', 'яркость': 450, 'max_power': 23.0, 'price_usd': 16.63}, 
 {'name': 'Qiangli R2 для помещений 3840 Гц (Гибкий)', 'env': 'Для помещений', 'высота звука': 2.0, 'tech': 'Гибкая', 'яркость': 500, 'max_power': 23.0, 'price_usd': 19.97}, 
 {'name': 'Qiangli Q2 для помещений 6000 Гц', 'env': 'Для помещений', 'высота звука': 2.0, 'tech': 'SMD', 'яркость': 600, 'max_power': 23.0, 'price_usd': 17.60}, 
 {'name': 'Qiangli R2 для помещений 6000 Гц (Гибкий)', 'env': 'Для помещений', 'высота звука': 2.0, 'tech': 'Гибкая', 'яркость': 500, 'max_power': 23.0, 'price_usd': 20.77}, 
 {'name': 'Qiangli Q2 для помещений с частотой 6000 Гц', 'env': 'Для помещений', 'высота звука': 2.0, 'tech': 'мощность', 'яркость': 600, 'max_power': 23.0, 'price_usd': 21.85}, 
 {'name': 'Qiangli Q2.5 для помещений с частотой 1920 Гц', 'env': 'Для помещений', 'высота звука': 2.5, 'tech': 'SMD', 'яркость': 450, 'max_power': 24.0, 'price_usd': 12.03},
 {'name': 'Qiangli Q2.5 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 2.5, 'tech': 'SMD', 'яркость': 450, 'max_power': 24.0, 'price_usd': 12.55}, 
 {'name': 'Qiangli R2.5 для помещений 3840 Гц (Гибкий)', 'env': 'Для помещений', 'высота звука': 2.5, 'tech': 'Гибкая', 'яркость': 500, 'max_power': 24.0, 'price_usd': 14.88}, 
 {'name': 'Qiangli Q2.5 для помещений с частотой 6000 Гц', 'env': 'Для помещений', 'высота звука': 2.5, 'tech': 'SMD', 'яркость': 500, 'max_power': 24.0, 'price_usd': 13.43}, 
 {'name': 'Qiangli R2.5 для помещений 6000 Гц (Гибкий)', 'env': 'Для помещений', 'высота звука': 2.5, 'tech': 'Гибкая', 'яркость': 600, 'max_power': 24.0, 'price_usd': 15.56}, 
 {'name': 'Qiangli Q3.07 для помещений с частотой 1920 Гц', 'env': 'Для помещений', 'высота звука': 3,07, 'tech': 'SMD', 'яркость': 500, 'max_power': 22,0, 'price_usd': 8,98}, 
 {'name': 'Qiangli Q3.07 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 3.07, 'tech': 'SMD', 'яркость': 600, 'max_power': 22.0, 'price_usd': 10.61}, 
 {'name': 'Qiangli Q3.07 для помещений 6000 Гц', 'env': 'Для помещений', 'высота звука': 3.07, 'tech': 'SMD', 'яркость': 600, 'max_power': 22.0, 'price_usd': 10.99},
 {'name': 'Qiangli Q4 для помещений с частотой 1920 Гц', 'env': 'Для помещений', 'высота звука': 4.0, 'tech': 'SMD', 'яркость': 450, 'max_power': 24.0, 'price_usd': 7.55}, 
 {'name': 'Qiangli Q4 для помещений 3840 Гц', 'env': 'Для помещений', 'высота звука': 4.0, 'tech': 'SMD', 'яркость': 600, 'max_power': 24.0, 'price_usd': 8.46}, 
 {'name': 'Qiangli Q4 для помещений 6000 Гц', 'env': 'Для помещений', 'высота звука': 4.0, 'tech': 'SMD', 'яркость': 600, 'max_power': 24.0, 'price_usd': 8.70},

 # ОТКРЫТЫЙ
 {'name': 'Qiangli Q2.5 Outdoor 3840Hz', 'env': 'Outdoor', 'высота звука': 2.5, 'tech': 'SMD', 'яркость': 4500, 'max_power': 33.0, 'price_usd': 24.39}, 
 {'name': 'Qiangli Q2.5 Outdoor 7680Hz', 'env': 'Outdoor', 'высота звука': 2.5, 'tech': 'SMD', 'яркость': 4500, 'max_power': 33.0, 'price_usd': 24.80}, 
 {'name': 'Qiangli Q3.07 Outdoor 2880Hz', 'env': 'Outdoor', 'высота звука': 3.07, 'tech': 'SMD', 'яркость': 4200, 'max_power': 40.0, 'price_usd': 15.29}, 
 {'name': 'Qiangli Q3.07 Outdoor 7680Hz', 'env': 'Outdoor', 'высота звука': 3.07, 'tech': 'SMD', 'яркость': 4500, 'max_power': 40.0, 'price_usd': 16.15},
 {'name': 'Qiangli Q4 Outdoor 2880Hz', 'env': 'Outdoor', 'высота звука': 4.0, 'tech': 'SMD', 'яркость': 5000, 'max_power': 47.0, 'price_usd': 11.02}, 
 {'name': 'Qiangli R4 Outdoor 3840Hz (Гибкий)', 'env': 'Outdoor', 'высота звука': 4.0, 'tech': 'Гибкая', 'яркость': 5000, 'max_power': 46.0, 'price_usd': 25.09}, 
 {'name': 'Qiangli Q4 Outdoor 7680Hz', 'env': 'Outdoor', 'высота звука': 4.0, 'tech': 'SMD', 'яркость': 5000, 'max_power': 47.0, 'price_usd': 11.49}, 
 {'name': 'Qiangli Q5 Outdoor 2880Hz', 'env': 'Outdoor', 'высота звука': 5.0, 'tech': 'SMD', 'яркость': 5000, 'max_power': 43.0, 'price_usd': 9.08}, 
 {'name': 'Qiangli Q5 Outdoor 7680Hz', 'env': 'Outdoor', 'высота звука': 5.0, 'tech': 'SMD', 'яркость': 5000, 'max_power': 43.0, 'price_usd': 9.55}, 
 {'name': 'Qiangli Q6.66 Outdoor 2880Hz', 'env': 'Outdoor', 'высота звука': 6.66, 'tech': 'SMD', 'яркость': 4500, 'max_power': 46.0, 'price_usd': 8.87}, 
 {'name': 'Qiangli Q6.66 Outdoor 7680Hz', 'env': 'Outdoor', 'высота звука': 6.66, 'tech': 'SMD', 'яркость': 5000, 'max_power': 46.0, 'price_usd': 9.30},
 {'name': 'Qiangli Q8 Outdoor 2880Hz', 'env': 'Outdoor', 'высота звука': 8.0, 'tech': 'SMD', 'яркость': 4500, 'max_power': 44.0, 'price_usd': 7.65}, 
 {'name': 'Qiangli Q8 Outdoor 7680Hz', 'env': 'Outdoor', 'высота звука': 8.0, 'tech': 'SMD', 'яркость': 4500, 'max_power': 44.0, 'price_usd': 8.05}, 
]
# Синхронные контроллеры (USD: LEDCapital 23.03.2026)
SYNC_CONTROLLERS_DB = [ 
 {"название": "Novastar MSD 300", "price_usd": 100.63}, 
 ...
 {"название": "Novastar MCTRL 660 Pro", "price_usd": 810.40}, 
 {"name": "Novastar MX30", "price_usd": 2228.28}, 
 {"название": "Novastar MX40 Pro", "price_usd": 5657.79}, 
...
# --- ДОБАВЛЯЕМ НОВЫЕ СПРАВОЧНИКИ ПО КАРТАМ И ХАБАМ ---
RECEIVING_CARDS_DB = [ 
 {"название": "Novastar MRV 208", "price_usd": 13.29, "тип": "MRV"}, 
 ...
 {"название": "Novastar A10s Pro", "price_usd": 71.31, "тип": "A"}, 
]
# Блоки питания (USD: LEDCapital 23.03.2026; позиции Chuanglian/серия A по прайсу)
PSU_DB = [ 
 {"name": "A-200-5 (Чжуанлянь)", "price_usd": 6.84, "max_w": 200}, 
 {"name": "A-200-5N (Slim) (Чжуанлянь)", "price_usd": 12.80, "max_w": 200}, 
 {"name": "A-300-5 (Slim) (Чжуанлянь)", "price_usd": 14.27, "max_w": 300}, 
 {"name": "A-200JQ-5 slim (Чжуанлянь)", "price_usd": 13.87, "max_w": 200}, 
 {"name": "A-300FAR-4.5PH (чжуанлянь)", "price_usd": 21.79, "max_w": 300}, 
 {"name": "A-400JQ-4.5PH (чжуанлянь)", "price_usd": 14.86, "max_w": 400}, 
...
HUBS_DB = [ 
 {"название": "HUB 75E", "price_usd": 5.29}, 
 {"name": "КОНЦЕНТРАТОР 75E-AXS", "price_usd": 14.86}, 
 {"name": "КОНЦЕНТРАТОР 320-AXS", "price_usd": 14.86}, 
]
...
# Кабель питания приемной карты ↔ блок питания (LEDCapital 23.03.2026)
...
# Силовые перемычки между блоками питания (LEDCapital, 23.03.2026). Монолит: выбор длины; кабинеты — позже в калькуляторе.
...
# Магниты для монолитного монтажа (прайс-лист LEDCapital: цена за упаковку; в калькуляторе — за шт.)
MAGNETS_DB = [
...
# Количество выходов Gigabit Ethernet под нагрузку на приемные карты (основной контур).
# Ключи совпадают с полем name в SYNC_CONTROLLERS_DB / ASYNC_CONTROLLERS_DB.
# Источники: novastar.Технические характеристики и общедоступные спецификации уточняйте в соответствии с вашей версией железа.
PROCESSOR_PORTS = {
...
def get_processor_output_ports(processor_name: str) -> tuple[int, bool]:
 ...
 если processor_name в PROCESSOR_PORTS:
 возвращает PROCESSOR_PORTS[processor_name], True 
 возвращает 1, False
...
if "height_mm" not in st.session_state: st.session_state.высота , мм = 2240 
если "previous_selected" отсутствует в st.session_state: st.session_state.previous_selected = "3840 × 2240 мм (12×14 шт) / ~16:9"

определение fit_ratio(соотношения):
 идеально = st.session_state.width_input / соотношение 
 нижний = математический этаж (идеально / 160) * 160
 верхний = математический уровень (идеально / 160) * 160 
 st.session_state.height_mm = нижний, если abs (идеально - нижний) <= abs (идеально - верхний), иначе верхний
...
project_name = st.sidebar.text_input("Название проекта", value="MediaLive — новый проект")
...
exchange_rate = st.sidebar.number_input(
 "Курс доллара США (₽) для закупки (ЦБ + 1%)", 
 min_value=50.0, 
 value=float(current_cbr_rate), 
 step=0.1,
 help="Курс автоматически берется с сайта ЦБ РФ + добавляется 1%, согласно правилам прайс-листа."
)
...
st.боковая панель.markdown("---")
# Оставляем цену за м2, если она нужна вам для других расчетов
price_per_m2 = st.sidebar.number_input("Цена за м² для клиента (₽)", min_value=0, value=150000, step=5000)

st.title("🖥️ Профессиональный калькулятор для расчета светодиодных экранов")
st.markdown("Точный расчет комплектующих на основе динамического прайс-листа LEDCapital.")
...
btn_cols = st.столбцы(4) 
if btn_cols[0].кнопка("16:9 (Широкий)"): fit_ratio(1.77777777777777777777); st.повторный запуск() 
if btn_cols[1].кнопка("4:3 (ТВ)"): fit_ratio(1.33333333333333333333); st.повторный запуск() 
if btn_cols[2].кнопка("21:9 (Кино)"): fit_ratio(2.333333333333333335); st.повторный запуск() 
if btn_cols[3].кнопка("1:1 (Квадрат)"): fit_ratio(1.0); st.повторный запуск()
...
with col_mat:
 ...
 with c_env:
 env_key = st.radio("Среда использования", ["В помещении", "На улице"], horizontal=True)
 with c_tech:
...
with col_mount:
 ...
 с cc2: cabinet_height = st.number_input("Высота (мм)", min_value=160, value=480)
 с cc3: cabinet_weight_per = st.number_input("Вес (кг)", min_value=1.0, value=20.0)
 иначе:
 cab_map = {
 ...
 help="Стоимость включена в «Общий заказ». Количество = число модулей × норма, указанная ниже.",
 )
 ...
 help="Обычно 4 шт. на модуль; укажите норму, соответствующую конструкции.",
 )
 ...
 <span style="color: #a0aec0; font-size: 13px;">
 Упаковка: <strong>{selected_magnet['pack_qty']} шт</strong> по
 <strong style="color: #48bb78;">${selected_magnet['pack_price_usd']:.2f}</strong>
 </span>
 </div>
 """, unsafe_allow_html=True)

 st.markdown("**Силовые перемычки** (между блоками питания в шлейфе, из прайса)")
 _pj_default_ix = next(
 ...
 help="Для монолита по умолчанию **70 см**. Расчёт перемычек для кабинетов добавим отдельно.",
 )
 _pj_rub = selected_power_jumper["price_usd"] * обменный курс
 st.markdown(f"""
 <div style="padding: 12px; border-radius: 8px; border: 1px solid #2d3748; background: #1a202c; font-size: 14px; color: #e2e8f0; margin-bottom: 10px;">
 <span style="color: #a0aec0;">Цена за шт.:</span>
 <strong style="color: #48bb78;">${selected_power_jumper["price_usd"]:.2f}</strong> ({_pj_rub:.2f} ₽)<br>
 <span style="color: #a0aec0; font-size: 13px;">Количество = (число БП с ЗИП − 1), стоимость — в разделе «Общая закупка».</span>
 </div>
 """, unsafe_allow_html=True)
...
with col_ctrl1:
 ...
 current_db = SYNC_CONTROLLERS_DB, если ctrl_category == "Синхронная", иначе ASYNC_CONTROLLERS_DB
...
with col_ctrl2:
 ...
 # Список значений, как ты и просил, + стандартные для больших экранов
 card_mods_options = [6, 8, 10, 12, 14, 16, 18]
 
 modules_per_card = st.selectbox(
 "Кол-во модулей на 1 карту:", 
 options=card_mods_options,
 index=3, # По умолчанию выбирается 12 (четвертый вариант в списке)
 ...
 # ЛОГИКА ПОКАЗА РАЗРЕШЕНИЯ
 if any(model_num in card_name for model_num in ["412", "416"]):
 res_info = "512x512 (N) / 512x384"
 else:
 res_info = "256x256"

 # ИНФОРМАЦИОННАЯ ПЛАШКА КАРТЫ
 st.markdown(f"""
 <div style="padding: 12px; border-radius: 8px; background: #1a202c; border: 1px solid #2d3748; line-height: 1.6; margin-bottom: 10px;">
 <span style="color: #a0aec0; font-size: 13px;">
...
if not ports_catalog_hit:
 st.warning(
 f"Модель **{processor_name}** не найдена в справочнике портов — для расчета принято **1** выход. "
 "Добавьте строку в `PROCESSOR_PORTS` в `app.py`."
 )

# РАСЧЕТЫ ДОЛЖНЫ ИДТИ ПОСЛЕ БЛОКА IF С ТЕМ ЖЕ ОТСТУПОМ, ЧТО И ВЕСЬ БЛОК
real_width = математический размер(width_mm / 320) * 320
...
load_per_port = (total_px / (available_ports * 650000)) * 100, если available_ports > 0, иначе 100.0

status_text = "✅ Портов достаточно" if required_ports <= available_ports else "❌ ВНИМАНИЕ: Недостаточно портов!"
status_color = "#48bb78", если required_ports <= available_ports else "#f56565"
...
# ==========================================
# БЛОК 4: ПИТАНИЕ И РЕЗЕРВ (ЗИП) - ОКОНЧАТЕЛЬНЫЙ ЧИСТЫЙ ВАРИАНТ
# ==========================================
...
with col_pwr:
 ...
 # Инфо-плашка (для удобства оставим и доллары, и пересчет в рубли)
 st.markdown(f"""
 <div style="padding: 12px; border-radius: 8px; border: 1px solid #2d3748; background: #1a202c; font-size: 14px; color: #e2e8f0; margin-bottom: 10px;">
 <span style="color: #a0aec0;">Мощность:</span> <strong>{sel_psu['max_w']} Вт</strong> &nbsp;|&nbsp;
...
with col_zip:
 ...
 st.markdown("**Патч-корды** (учет в разделе «Общая закупка»)")
 ...
 _p_rub = selected_patch_cord["price_usd"] * обменный курс
 st.markdown(f"""
 <div style="padding: 12px; border-radius: 8px; border: 1px solid #2d3748; background: #1a202c; font-size: 14px; color: #e2e8f0; margin-bottom: 10px;">
 <span style="color: #a0aec0;">Цена за шт.:</span>
 <strong style="color: #48bb78;">${selected_patch_cord["price_usd"]:.2f}</strong> ({_p_rub:.2f} ₽)
 ...
 st.markdown("**Кабели питания приемных карт → БП** (учет в разделе «Общая закупка»)")
 ...
 _cp_rub = selected_card_power_cable["price_usd"] * обменный курс
 st.markdown(f"""
 <div style="padding: 12px; border-radius: 8px; border: 1px solid #2d3748; background: #1a202c; font-size: 14px; color: #e2e8f0; margin-bottom: 10px;">
...
# ==========================================
# ==========================================
# ПОЛНЫЕ ИНЖЕНЕРНЫЕ РАСЧЕТЫ (ИСПРАВЛЕНО)
# ==========================================
...
reserve_modules = математический индекс(total_modules * reserve_percent / 100) 
total_modules_order = total_modules + reserve_modules

# --- 1. МОЩНОСТЬ (ВАЖНО!) ---
пик_мощности_screen_kw = всего_модулей * максимальная_мощность_модуля / 1000
среднее значение_мощности_screen_kw = пик_мощности_screen_kw * 0.35
...
# Б) Для контроля: физический предел разрешения карты (Novastar)
...
# Если вы вручную задали мало модулей (например, 6), то num_cards_by_mod будет большим, 
# и программа возьмет именно его. 
num_cards = max(num_cards_by_mod, num_cards_by_pix)

# Г) ИТОГО С УЧЕТОМ ЗАПАСНЫХ ЧАСТЕЙ (если нажата кнопка запаса)
num_cards_reserve = num_cards + 1 if reserve_psu_cards else num_cards

патч-корды = num_cards_reserve * (2, если есть резервный патч-корд, иначе 1)
купить_патч-корды_всего = патч-корды * selected_patch_cord["price_usd"]

количество_кабелей_питания = num_cards_reserve
зарезервировать_кабели_питания = math.ceil(количество_кабелей_питания * 0,1)
...
num_power_jumpers = (
 ...
 if ("Монолитный" в mount_type и selected_power_jumper не равен None)
 else 0
)
...
# --- 4b. МАГНИТЫ (только для монолита; норма задается в блоке монтажа) ---
num_magnets = (
...
# 1. Сначала определяем цену модуля для расчетов (берем ту, что указана выше)
module_price_usd = price_usd # Теперь ошибка NameError исчезнет
...
buy_psu_total = num_psu_reserve * sel_psu["цена за доллар"]
...
# 4. Пересчет модулей для отчета (как у вас в коде)
total_modules_cost_usd = total_modules * module_price_usd
total_modules_cost_rub = total_modules_cost_usd * обменный курс

# 5. Общая закупка в рублях
total_buy_rub = total_buy_usd * обменный курс

# --- 6. ЭЛЕКТРИКА (ТЕПЕРЬ РАБОТАЕТ) ---
электрическая мощность , кВт = максимальная мощность, экран , кВт * 1,20
if "Одна фаза" in power_phase:
 ток = (electrical_power_kw * 1000) / 220 
 жилы = 3
остальное: 
 ток = (electrical_power_kw * 1000) / (380 * математическая величина sqrt(3)) 
 количество ядер = 5
...
длина вершины = real_height - 40 
horiz_profiles = 2, если real_height <= 3000, иначе 3 
...
винты = num_plates * 4
reserve_vinths = math.ceil(винты * 0.1)
...
# Вес
module_weight = 0,37, если "Indoor" в env_key, иначе 0,5
...
weight_carcas = total_profile_length * 2, если "Монолитный" в mount_type, иначе 0 
...
# Логистика
num_boxes = математический файл(total_modules_order / 40)
box_weight = количество коробок * 22
box_volume = количество коробок * 0.06
...
# БЛОК 5: ПОЛНЫЙ ДЕТАЛЬНЫЙ ОТЧЕТ
# ==========================================
st.markdown('<div class="section-header">📊 Итоговый отчет и спецификация</div>', unsafe_allow_html=True)

# Верхний ряд: технические показатели
...
with col_m3: 
 st.markdown(f'<div class="метрическая карточка"><div class="метрическая метка">Рабочая мощн.</div><div class="значение метрики">{avg_power_screen_kw:.1f} кВт</div></div>', unsafe_allow_html=True)

st.уценка ("---")

# Нижний ряд: финансовые показатели (покупка ВСЕГО и продажа ВСЕГО)
...
with col_f2:
 ...
 <div style="color: #a0aec0; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px;">Смета на продажу (экран)</div>
 <div style="margin: 10px 0;">
...
с помощью st.expander("Принимающие карты", expanded=True):
 st.markdown(f"""
...
с помощью st.expander("Патч-корды", expanded=True):
 st.markdown(f"""
 - **Позиция**: {selected_patch_cord['name']}
 - **Количество**: **{patch_cords} шт.** (по количеству карт с ЗИП × {"2" если reserve_patch, иначе "1"})
 - **Стоимость**: ${selected_patch_cord['price_usd']:.2f}/шт → **${buy_patch_cords_total:.2f}** ({buy_patch_cords_total * exchange_rate:,.0f} ₽)
 """)
...
with st.expander("Кабели питания карт", expanded=True):
 ...
 - **Покупка**: ${selected_card_power_cable['price_usd']:.2f}/шт → **${buy_card_power_cables_total:.2f}** ({buy_card_power_cables_total * exchange_rate:,.0f} ₽)
 """)
...
if "Монолитный" in mount_type and selected_magnet is not None:
 ...
 - **Цена закупки**: ${magnet_unit_price_usd:.4f}/шт. (всего ${buy_magnets_total:.2f}, {buy_magnets_total * exchange_rate:,.0f} ₽)
 """)

with st.expander("Блоки питания", expanded=True):
 st.markdown(f"""
 - **Модель блока питания**: {sel_psu['name']} ({sel_psu['max_w']} Вт)
 - **Схема подключения**: {modules_per_psu} модулей на 1 блок питания
 - **Пиковое потребление экрана**: {peak_power_screen_kw:.1f} кВт
 - **Рабочее (среднее) потребление**: {avg_power_screen_kw:.1f} кВт
 - **Основное количество блоков питания**: {num_psu} шт.
 - **Итого блоков питания к заказу (с ЗИП)**: **{num_psu_reserve} шт.**
 """)
...
with st.expander("Вводная сеть", expanded=True):
 ...
 - **Номинал автоматического выключателя**: {breaker} А (тип C)
 """)

if "Монолитный" в mount_type:
 с помощью st.expander("Каркас и крепеж (монолитный)", expanded=True):
 st.markdown(f"""
 ...
 - **Винты 4×16 со сверлом для профилей**: {винты} шт. + {reserve_vinths} шт. (запас 10%)
 """)

with st.expander("Внутренняя коммутация", expanded=True):
 if "Монолитный" in mount_type:
 st.markdown(f"""
 - **Силовые перемычки** ({selected_power_jumper['name']}): **{num_power_jumpers} шт.**
 (между блоками питания в шлейфе: {num_psu_reserve} блоков питания → {num_power_jumpers} перемычек)
...
с помощью st.expander("Весовые характеристики", expanded=True):
 st.markdown(f"""
 - **Вес модулей**: {weight_modules:.1f} кг
 - **Вес каркаса / кабинетов**: {weight_carcas + total_cabinet_weight:.1f} кг
 - **Крепежные элементы и проводка (5%)**: {weight_extra:.1f} кг
 - **Общий расчетный вес экрана**: **{total_weight:.1f} кг**
 """)
...
figma_data = {
 "имя_проекта": имя_проекта, "клиент": имя_клиента, "дата": datetime.datetime.now().strftime("%Y-%m-%d"), 
 "screen_dimensions_mm": f"{real_width}x{real_height}", "resolution_px": f"{int(real_width/pixel_pitch)}x{int(real_height/pixel_pitch)}", 
 "area_m2": круглый (area_m2, 2), "pixel_pitch": пиксель_pitch, "total_modules": total_modules_order, 
 "receiving_cards": num_cards_reserve, "power_supplies": num_psu_reserve, "processor": selected_proc['имя'], 
 "magnets_qty": количество магнитов, 
 "magnets_per_module": magnets_per_module, 
 "magnets_cost_usd": круглый (buy_magnets_total, 2), 
 "patch_cords_qty": patch_cords, 
 "patch_cord_model": выбранный параметр patch_cord["имя"], 
 "patch_cords_cost_usd": круглый (buy_patch_cords_total, 2), 
 "card_power_cables_qty": порядковый номер card_power_cables_order, 
 "card_power_cable_model": выбранная модель card_power_cable["имя"], 
 "card_power_cables_cost_usd": круглый (buy_card_power_cables_total, 2), 
 "power_jumpers_qty": количество мощных джамперов, 
 "power_jumper_model": selected_power_jumper["имя"], если selected_power_jumper еще нет,
 "power_jumpers_cost_usd": круглый (buy_power_jumpers_total, 2), 
 "peak_power_kw": раунд (peak_power_screen_kw, 2), "avg_power_kw": раунд (avg_power_screen_kw, 2), 
...
с помощью col_exp2:
 st.markdown("**Сохранение в базу данных Google Таблиц**")
 if st.button("💾 Отправить расчёт в облако", use_container_width=True):
 if "google_sheets" in st.secrets:
 st.success("✅ Сохранено в Google Таблицах!")
 else:
 st.warning("Секреты `st.secrets['google_sheets']` не настроены.")
 st.success("✅ [Макет] Данные сформированы для отправки в базу!")
